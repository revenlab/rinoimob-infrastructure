...
ASAAS_API_KEY=
ASAAS_WEBHOOK_TOKEN=
ASAAS_PAST_DUE_SCAN_INTERVAL_MS=3600000
# Sandbox: ASAAS_BASE_URL=https://api-sandbox.asaas.com
# Configure the Asaas webhook at https://api.seudominio.com/api/v1/webhooks/asaas
# with CHECKOUT_PAID, CHECKOUT_CANCELED, CHECKOUT_EXPIRED, PAYMENT_RECEIVED,
# PAYMENT_OVERDUE and PAYMENT_REFUNDED events.
```
